...
public class FieldOrientedWithCardinal extends Command {
  ...
  public FieldOrientedWithCardinal(
    ...
    thetaFF = new SimpleMotorFeedforward(ffConstants.kS, ffConstants.kV, ffConstants.kA); // TODO tune
  ...
  public void execute() {
    ...
    double cardinalRotSpeed = thetaPID.calculate(poseEstimator.getFusedPose().getRotation().getRadians());
