...
public class NeoModule implements SwerveModule {
  ...
  /**
   * Initializes the NEO module. This should be called in the constructor of the
   * module class.
   */
  @Override
  ...
  /**
   * @return The absolute position of the drive encoder, as a
   *         {@link Rotation2d#Rotation2d
   *         Rotation2d}
   */
  @Override
  ...
  /**
   * @return The state of the module as a
   *         {@link SwerveModuleState#SwerveModuleState
   *         SwerveModuleState}
   */
  @Override
  ...
  /**
   * @return The position of the module as a
   *         {@link SwerveModulePosition#SwerveModulePosition
  ...
  /**
   * Sets the desired velocity of the module. Should only be used if you want to
   * ONLY set the
  ...
  /**
   * Sets the desired rotation of the module. Should only be used if you want to
   * ONLY set the
  ...
  public void setRotation(Rotation2d rotation) {
    ...
    SwerveModuleState correctedState = SwerveModuleState.optimize(new SwerveModuleState(0, rotation),
        getSteerPosition());
  ...
  /**
   * Sets the desired state of the module. Should be used if you want to set both
   * the velocity and
  ...
  public void setState(SwerveModuleState state) {
    ...
    double speedModifier = Math.abs(Math.cos(((optimizedState.angle.getRadians()) - getSteerPosition().getRadians())));
  ...
  private final MutableMeasure<Velocity<Distance>> mutableVelocity = MutableMeasure.mutable(MetersPerSecond.of(0));
