...
/**
 * This is the parent interface for a SwerveModule. It is used to define the
 * methods that all
 * SwerveModules must implement. Recourse for this can be found in the
 * repository wiki,
...
public interface SwerveModule {
  ...
  /**
   * Runs the drive motor at a set voltage, while keeping the steer angle at 0
   * degrees
   */
