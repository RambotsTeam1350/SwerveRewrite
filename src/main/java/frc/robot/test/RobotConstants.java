...
class RobotConstants {
        public static final double WHEEL_WIDTH = Units.inchesToMeters(25.5); // Make sure this is from the wheel's
                                                                             // center
                                                                             // of rotation
        public static final double WHEEL_DIAMETER = 0.096706557; // in meters // TODO measure more precisely
        ...
        public static final Transform3d CAM1_OFFSET = new Transform3d(
        ...
        public static final Structs.MotionLimits MOTION_LIMITS = new Structs.MotionLimits(4, 3 /* TODO */, 8, 18);
        ...
        // a target pose,
        // perhaps we could use just one set of constants for both Pathplanner and other
        // drive commands?
        ...
        public static final Constraints ROTATION_CONSTRAINTS = new Constraints(MOTION_LIMITS.maxAngularSpeed,
        ...
        // WHEELS
        public static final double DRIVE_GEAR_RATIO = (36.0 / 14.0) * (18.0 / 24.0) * (45.0 / 15.0);;
        public static final double STEER_GEAR_RATIO = (50.0 / 14.0) * (72.0 / 14.0);
        public static final double NEO_FREESPEED_RPS = 5676 / 60; // Free RPM of NEO to RPS
        public static final double DRIVE_WHEEL_FREESPEED = (NEO_FREESPEED_RPS * (WHEEL_DIAMETER * Math.PI))
